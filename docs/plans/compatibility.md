...
with 129 `glab` smoke checks covering auth, users, projects, nested groups,
...
milestones, branches, protected branches, tags, releases, project CI/CD variable
CLI workflows, commit APIs, repository compare, commit statuses, merge request
APIs, merge request CLI workflows, pipeline APIs, CI trace/artifacts, manual
