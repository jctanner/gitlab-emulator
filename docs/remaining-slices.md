...
precedence and metadata, richer `rules`, richer `needs`, deeper `extends`,
...
- Full GitLab authorization parity across all endpoints. The MVP CI
  ...
  member, org repository, organization-targeted fork, and team management writes require Owner. Project/repository
