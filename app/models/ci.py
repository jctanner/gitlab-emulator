...
class Pipeline(Base):
    ...
    before_sha: Mapped[str | None] = mapped_column(String, nullable=True)
...
class PipelineJob(Base):
    ...
    trigger_strategy: Mapped[str | None] = mapped_column(String, nullable=True)
    downstream_pipeline_id: Mapped[int | None] = mapped_column(Integer, nullable=True)
